import{j as a}from"./jsx-runtime-D_zvdyIk.js";import{R as i}from"./index-D4lIrffr.js";import{m as l,S as p,C as g}from"./mock-DJvFOcGU.js";import{E as m}from"./EasyFlatList-D15szM-x.js";const b={title:"component/EasyFlatList",component:m,args:{data:l,getNodeLabel:e=>e.name,search:"",autoFocusItem:!1},argTypes:{data:{table:{category:"common props"}},getNodeLabel:{table:{category:"common props"}},endAdornment:{table:{category:"common props"}},startAdornment:{table:{category:"common props"}},search:{table:{type:{summary:"string | null"}},control:"text"},selectedId:{table:{type:{summary:"string | number | null"}},control:"radio",options:l.map(e=>e.id)},onSelect:{table:{type:{summary:"(node: T | null) => void"}}}}},s={},o={args:{search:"0"}},n={args:{endAdornment:(e,t,d)=>!e.age||!d?null:a.jsx(g,{color:"success",size:"small",label:e.age}),startAdornment:(e,t)=>t===1?a.jsx(p,{color:"error"}):null}},c={render:e=>{const[t,d]=i.useState(3),u=e.data?.find(r=>r.id===t);return a.jsxs(a.Fragment,{children:["you select: ",u?.name,a.jsx(m,{search:"0",data:e.data||l,getNodeLabel:r=>r.name,selectedId:t,onSelect:r=>{d(r?.id??null)},autoFocusItem:!0})]})}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:"{}",...s.parameters?.docs?.source}}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  args: {
    search: '0'
  }
